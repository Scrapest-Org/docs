...
```bash
curl -X POST http://57.130.19.92:6969/auth
```
...
```bash curl
curl -X GET http://57.130.19.92:6969/health \
  -H "x-api-key: your-api-key"
```

```javascript fetch
fetch("http://57.130.19.92:6969/health", {
  method: "GET",
  headers: {
...
url = "http://57.130.19.92:6969/health"
headers = {
    "x-api-key": "your-api-key"
}
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let res = client
        .get("http://57.130.19.92:6969/health")
