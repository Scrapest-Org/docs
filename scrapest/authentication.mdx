...
description: "Authenticating requests to the Scrapest Service"
---
...
<Tip>
  You can set your API key globally for these docs by clicking the **Auth**
  button in the top navigation bar. This will pre-fill the key for all
...
```bash
curl -X POST https://scrapest.duckdns.org/auth
```
...
url = "https://scrapest.duckdns.org/health"
headers = {
    "x-api-key": "your-api-key"
}
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let res = client
        .get("https://scrapest.duckdns.org/health")
